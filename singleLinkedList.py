...
class SLL:
    ...
    def search(self, data):
        ...
        """
        if self.head is None:
            return "Linked List is empty. No needs to search."
    ...
    def remove(self, data):
        ...
        The time complexity is O(n) because in the worste case we have to visit every Node before we find
